  ...
  return (
    <div className=" relative flex flex-col h-full w-full">
      <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-4 mt-4">
        ...
        <GroupsComponent orgId={session.session.activeOrganizationId} className="col-span-2 md:col-span-2 lg:col-span-2" />
        <UsersComponent orgId={session.session.activeOrganizationId} className="col-span-2 md:col-span-2 lg:col-span-3" />
        <GroupsComponent orgId={session.session.activeOrganizationId} className="col-span-2 md:col-span-2 lg:col-span-2" />
        <DevicesDashboard orgId={session.session.activeOrganizationId} className="col-span-4 md:col-span-4 lg:col-span-5" />
        <GroupsComponent orgId={session.session.activeOrganizationId} className="col-span-2 md:col-span-2 lg:col-span-2" />
        <DevicesDashboard orgId={session.session.activeOrganizationId} className="col-span-4 md:col-span-4 lg:col-span-5" />
